...
public record GenericMetadata()
{
    ...
    public Dictionary<JobTag, string[]> Credits => new() {
        {JobTag.Creator, this.Creators},
        {JobTag.Writer, this.Writers},
        {JobTag.Penciller, this.Pencillers},
        {JobTag.Inker, this.Inkers},
        {JobTag.Colorist, this.Colorists},
        {JobTag.Letterer, this.Letterers},
        {JobTag.Editor, this.Editors},
        {JobTag.CoverArtist, this.CoverArtists},
        {JobTag.Translator, this.Translators},
    };
